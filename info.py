...
BOT_TOKEN = environ.get("BOT_TOKEN", "8887127574:AAHZ97-wwawXEZId5B80hfGPXlPbGQomY44")
PORT = environ.get("PORT", "8082")

# Owners
ADMINS = [
    int(admin) if id_pattern.search(admin) else admin
    for admin in environ.get("ADMINS", "777000").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "KingKN01"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "KingKN01")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1003823902223").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1003928657783"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1003914711028"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1003622614396"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1003994033962"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1003990536336"))
...
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://Kingkishan1:229961@cluster1.dmixne4.mongodb.net/?appName=Cluster1")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "jisshu")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003449452691"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "-1003777314225"))
request_channel = environ.get("REQUEST_CHANNEL", "-1003608642564")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1003932415459"))
# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "-1003449452691")
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://graph.org/file/1b198fddf7def76942176-da9921339b6d1d17b4.jpg",
    )
).split()
